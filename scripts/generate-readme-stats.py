...
console.print(Columns([Panel(summary, title=f" {n} Papers", border_style="dim", box=box.ROUNDED), Panel(year_table, title="Papers by Year", border_style="dim", box=box.ROUNDED)]))
