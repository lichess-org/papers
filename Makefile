...
tidy:
	npx bibtex-tidy --sort --curly --no-escape --blank-lines --duplicates --sort-fields=$(SORT_FIELDS) --modify --remove-empty-fields --trailing-commas --omit=timestamp,biburl,bibsource lichess.bib
